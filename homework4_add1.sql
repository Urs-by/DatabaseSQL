...
FROM AUTO GROUP BY mark, color 
HAVING mark = "BMW" OR mark="LADA";


-- 2. Вывести на экран марку авто и количество AUTO не этой марки

SELECT  mark, (SELECT COUNT(*)FROM AUTO)-COUNT(*) AS "Количество других AUTO" FROM AUTO GROUP BY mark;

SELECT mark,  SUM(COUNT(*)) OVER () -  COUNT(*) AS total_cars
FROM AUTO
GROUP BY mark;
